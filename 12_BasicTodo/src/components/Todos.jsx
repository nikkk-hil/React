...
import { removeTodo, toggleIsEditable } from '../features/todo/todoSlice' 

function Todos() {
    const todos = useSelector(state => state.todos) //getting todos array through useSelector
    ...
    <ul className="list-none">
        {todos.map((todo) => (
          ...
          >
            ...
            <div>
              <button
                onClick={() => dispatch(toggleIsEditable(todo.id))}
